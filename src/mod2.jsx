...
function mod2() {
  ...
  return (
    <div className="content">
      ...
      <h1 className="text-[#F38D0D]-500">Flickering Lights</h1>
        ...
        <table className="w-full text-sm text-left text-[#0F254C] dark:text-gray-400">
          ...
          <tbody>
            ...
            <tr className="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
              ...
              <td className="px-6 py-4">phagwara</td>
              <td className="px-6 py-4">
                {/* drawer init and toggle */}
                <button
                  type="button"
                ...
                >
                  ...
                  <p className="mb-6 text-sm text-gray-500 dark:text-gray-400">
                    {" "}
                    Hey Mechanics, there is Flickering light found at electric
                    pole number: 12390453 in your location. Here is list of
                    Mechanic you can notify to fix it..
                  </p>
                  <div className="grid grid-cols-2 gap-4">
                    <a
                      href="#"
